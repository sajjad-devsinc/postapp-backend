...
router.post(
  '/',passport.authenticate('jwt', { session: false }),postValidation.validate("addPost"),newPost
)
router.get(
...
router.put(
  '/:pid',passport.authenticate('jwt', { session: false }),postValidation.validate("editPost"),editPost
)
router.delete(
